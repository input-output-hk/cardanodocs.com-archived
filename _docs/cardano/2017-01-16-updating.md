...
processing, but has several important benefits:
 ...
 1. For each client implementing the protocol, its latest
 version from blockchain is known.
 ...
 distribute an update rapidly (and still under agreement of the majority
 of stake).
