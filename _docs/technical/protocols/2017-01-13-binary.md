...
`VerInfo` we sending is created in [this piece of
code](https://github.com/input-output-hk/cardano-sl/blob/e9a1e92c5ce53208782df73f5d35e33395f8caa8/src/Pos/Launcher/Runner.hs#L204).
