...
|---------------------------------------------+----------------+-----------+----------------|
| OneMessageHandler                           | Word8          | 0000 0000 | none           |
...
<!-- TODO: remove OneMsgHandler -->

Examples:

~~~
ghci> hexEncode OneMsgHandler
"00"
...
All specs for current protocol are stored directly in code in variable
[allOutSpecs](https://github.com/input-output-hk/cardano-sl/blob/e9a1e92c5ce53208782df73f5d35e33395f8caa8/src/Pos/Communication/Specs.hs#L43).

Examples:

~~~
ghci> let OutSpecs outSpecs = allOutSpecs
ghci> hexEncode outSpecs
"04030800000103020900030801010103020901030802020103020902030803030103020903"
~~~
...
| Field size | Type       | Description                           |
|------------+------------+---------------------------------------|
|         14 | ByteString | PeerId is 14-byte length `ByteString` |

Examples:

~~~
ghci> hexEncode (PeerId "aba")
*** Exception: Wrong PeerId length 3
ghci> hexEncode (PeerId "0123456789ABCD")
"3031323334353637383941424344"
~~~
...
| Field size    | Type    | Description               |
|---------------+---------+---------------------------|
| 14            | PeerId  | PeerId of PeerData sender |
| size(VerInfo) | VerInfo | MessageName table         |

`VerInfo` we sending is created in
[this piece of code](https://github.com/input-output-hk/cardano-sl/blob/e9a1e92c5ce53208782df73f5d35e33395f8caa8/src/Pos/Launcher/Runner.hs#L204).
