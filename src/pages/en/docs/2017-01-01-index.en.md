...
Implementation](/en/cardano/differences-between-paper-and-the-implementation/), and then move on to [documentation on
protocols and implementation](/en/technical/protocols/csl-application-level/).
